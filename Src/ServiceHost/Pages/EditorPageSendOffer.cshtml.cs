...
{
    public class EditorPageSendOfferModel : PageModel
    {
        ...
        public EditorPageSendOfferModel(IPersonalPageQuery personalPageQuery, IPersonalPageApplication personalPageApplication, IJobOfferApplication jobOfferApplication, IEmployerPageApplication employerPageApplication, IAuthHelper authHelper, IEmployerPageQuery employerPageQuery, ISmsService smsService)
        {
