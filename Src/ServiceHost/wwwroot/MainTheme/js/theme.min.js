...
function setPicture() {
    debugger;
    document.getElementById("PersonalPage_Picture").value = document.getElementsByName("picInput").value;
}
...
! function() {
    ...
    function() {
        ...
        function () {
            for (var n = document.querySelectorAll(".range-slider-money"), e = 0; e < n.length; e++) ! function (e) {
                var t = n[e].querySelector(".range-slider-ui-money"),
                    a = n[e].querySelector(".range-slider-value-min-money"),
                    r = n[e].querySelector(".range-slider-value-max-money"),
                    e = {
                        dataStartMin: parseInt(n[e].dataset.startMin, 10),
                        dataStartMax: parseInt(n[e].dataset.startMax, 10),
                        dataMin: parseInt(n[e].dataset.min, 10),
